...
void main() {
  ...
  group('ClaudeAdapter', () {
    ...
    test('a background task reporting back is not you', () {
      final a = ClaudeAdapter()
        ..addRecord({
          'type': 'user',
          'promptSource': 'typed',
          'message': {'role': 'user', 'content': 'dig into the boot screen'},
        })
        ..addRecord({
          'type': 'user',
          'promptSource': 'system',
          ...
          'message': {
            'role': 'user',
            'content': '<task-notification>\n<task-id>aa14</task-id>\n'
                '<status>failed</status>\n<summary>Agent "boot screen" failed: '
                "You've hit your session limit</summary>\n</task-notification>",
          },
        })
        ..addRecord({
          'type': 'user',
          ...
          'message': {
            'role': 'user',
            'content': '<task-notification>\n<task-id>bb22</task-id>\n'
                '<status>completed</status>\n<summary>Agent "hardware map" '
                'finished</summary>\n</task-notification>',
          },
        })
        ..addRecord({
      ...
      expect(a.turns.length, 1);
      expect(a.turns.single.errors.single, contains('session limit'));
      expect(a.turns.single.tools.single.label,
          'task · Agent "hardware map" finished');
    });
